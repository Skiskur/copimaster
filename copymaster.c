...
int main(int argc, char* argv[])
{
    ...
    if(slow(cpm_options.infile, cpm_options.outfile)){};

    if(fast(cpm_options.infile, cpm_options.outfile)){};

    if(create(cpm_options.infile, cpm_options.outfile)){};

    if(overwrite(cpm_options.infile, cpm_options.outfile)){};

    if(append(cpm_options.infile, cpm_options.outfile)){};

    if(lseek(cpm_options.infile, cpm_options.outfile)){};

    if(directory(cpm_options.infile, cpm_options.outfile)){};

    if(delete_opt(cpm_options.infile, cpm_options.outfile)){};

    if(chmod(cpm_options.infile, cpm_options.outfile)){};

    if(link(cpm_options.infile, cpm_options.outfile)){};

    if(truncate(cpm_options.infile, cpm_options.outfile)){};

    if(inode(cpm_options.infile, cpm_options.outfile)){};

    if(umask(cpm_options.infile, cpm_options.outfile)){};

    if(sparse(cpm_options.infile, cpm_options.outfile)){};
